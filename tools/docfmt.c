...
/*
  History:
    ...
    02jan07 rjs  Some standardizing.
***********************************************************************/
...
{
  fprintf(stderr,"%s\n",VERSION);
  fprintf(stderr,"Format a Miriad .doc file into a readable form\n\n");
  ...
  while (fgets(line,MAXLINE,fin) != NULL) {
    ...
    if (!echo && strncmp(line,"%A",2)) {
      ...
      case 'N':
        ...
        break;
      case 'D':
        fprintf(fout,"Purpose: %s",skip(line));
        break;
      case ':':
        fprintf(fout,"Categories: %s",skip(line));
        break;
      case 'B':
        fprintf(fout,"\n");
        break;
      ...
      case 'P':
        break;
      case 'R':
        fprintf(fout,"Revision: %s",skip(line));
        break;
      default:
        fputs(line,fout);
      }
