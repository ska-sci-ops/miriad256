...
c
        implicit none
        integer BufLen,Buf(BufLen)
        ptrdiff RBufLen,N,Index
...
c
        integer Stack(dim),StackPt,i,k,NInst,Tok,Operands
        ptrdiff RBufPt,Op1,Op2,Nd
c
        RBufPt = Buf(3)
        NInst = Buf(4)
        StackPt = 0
...
c
        implicit none
        character exp*(*)
        integer type, BufLen, Buf(Buflen), RBuflen
        real    RBuf(RBufLen)
        external paction
c
...
c------------------------------------------------------------------------
        ...
        integer Func,Operator,Numeric,Symbol,LBracket,Comma
        integer RBracket
...
c
        ...
        integer BufPt,StackPt,ExpectPt,SymPt
        integer p1,p2,N1,N2,Tok,i
        integer RBufPt,Index
...
c
c------------------------------------------------------------------------
        integer Func,Operator,Numeric,Symbol,LBracket
        integer Comma,RBracket
        parameter(Func=-7,Operator=-6,Numeric=-5,Symbol=-4)
        parameter(LBracket=-3,Comma=-2,RBracket=-1)
        character c*1
...
c
        implicit none
        character Exp*(*)
        integer p1,p2,SymPt,SymLen,Tok
        integer Index,RBufPt,RBufLen
...
c
        implicit none
        integer StackLen,BufLen,StackPt,BufPt,Prec
        integer Token,Stack(StackLen),Buf(BufLen)
c
...
c  vector or scalar with scalar.
c
c------------------------------------------------------------------------
        ptrdiff i
        real temp
